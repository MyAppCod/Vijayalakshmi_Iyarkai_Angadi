...
const Register = () => {
  ...
  return (
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #e8f5e9, #f1f8e9)', padding: '20px 0' }}>
      <div style={{ width: '100%', maxWidth: '420px', padding: '0 16px' }}>
        <div className="card border-0 shadow" style={{ borderRadius: '20px', overflow: 'hidden' }}>
          ...
          <div style={{ background: 'linear-gradient(135deg, #1b5e20, #2e7d32)', padding: '32px 32px 24px', textAlign: 'center', color: '#fff' }}>
            ...
            <p style={{ color: '#c8e6c9', fontSize: '14px', margin: 0 }}>Join Vijayalakshmi Iyarkai Angadi</p>
          </div>
          ...
          <div className="card-body p-4">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                <label className="form-label fw-medium text-muted small">Phone Number <span className="text-muted">(optional)</span></label>
                <div className="input-group">
                  <span className="input-group-text bg-light border-end-0">📱</span>
                  <input
                    type="tel"
